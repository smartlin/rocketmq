...
public class NettyServerConfig implements Cloneable {
     ...
     * 如何该业务类型（RequestCode）未注册线程池，则由public线程池执行
     */
    private int serverCallbackExecutorThreads = 0;
    /**
     * IO线程池个数
     * 主要是NameServer、Broker端解析请求、返回相应的线程个数，这类线程主要是处理网络请求的，解析请求包，然后转发到各个业务线程池完成具体的业务操作，然后将结果再返回调用方
     */
